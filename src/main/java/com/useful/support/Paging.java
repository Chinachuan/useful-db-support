...
public class Paging<T> {
	...
	private Map<Object, Object> mapCount = null; //自定义汇总项   add by junfei.liu
...
//		if(pageIndex>pageCount)this.pageIndex=pageCount;
	...
	public Map<Object, Object> getMapCount() {
		return mapCount;
	}
	public void setMapCount(Map<Object, Object> mapCount) {
